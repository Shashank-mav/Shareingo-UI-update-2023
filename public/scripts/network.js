...
class ServerConnection {
    ...
    _onDisconnect() {
        ...
        Events.fire('notify-user', 'connection dropped，Retry connection after 5 seconds...');
        clearTimeout(this._reconnectTimer);
...
class Peer {
    ...
    _onTransferCompleted() {
        ...
        this._busy = false;
        this._dequeueFile();
        Events.fire('notify-user', 'File sent successfully!');
    }
...
class RTCPeer extends Peer {
    ...
    constructor(serverConnection, peerId, peer) {
        ...
        if (!peerId) return; //If the other party has an ID, they will take the initiative to contact the other party，If you don't have an ID, wait for the other party to contact you
